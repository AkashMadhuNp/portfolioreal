...
class SkillChip extends StatelessWidget {
  ...
  IconData _getIconForSkill(String name) {
    ...
    } else if (lowerName.contains('firebase') || lowerName.contains('api') || lowerName.contains('backend')) {
      return Icons.cloud_queue;
    } else if (lowerName.contains('git')) {
      return Icons.code;
    } else if (lowerName.contains('design') || lowerName.contains('figma')) {
      return Icons.design_services;
    } else if (lowerName.contains('database') || lowerName.contains('sql') || lowerName.contains('hive')) {
      return Icons.storage;
    } else if (lowerName.contains('architecture') || lowerName.contains('mvc') || lowerName.contains('mvvm')) {
